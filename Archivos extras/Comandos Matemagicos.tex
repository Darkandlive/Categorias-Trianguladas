...
\cs_new:Nn \nicolas_shortseq:n
{
	\begin{tikzcd}[ampersand~replacement=\&,#1]
		...
		\IfSubStr{\l_nicolas_shortseq_lcr_tl}{t}{ \arrow{r}{\l_nicolas_shortseq_h_tl}\& \l_nicolas_shortseq_T_tl\IfSubStr{\l_nicolas_shortseq_lcr_tl}{n}{}{\l_nicolas_shortseq_A_tl}}{}
...
\NewDocumentCommand{\tikzarrow}{O{}m}
{
	\group_begin:
	\keys_set:nn {nicolas/tikzarrow}{#2}
	\nicolas_tikzarrow:n {#1}
	\group_end:
}

\keys_define:nn {nicolas/tikzarrow}
{
	A     .tl_set:N = \l_nicolas_tikzarrow_A_tl,
	B   .tl_set:N = \l_nicolas_tikzarrow_B_tl,
	f      .tl_set:N = \l_nicolas_tikzarrow_f_tl,
...
{
	\begin{tikzcd}[ampersand~replacement=\&,#1]
		\l_nicolas_tikzarrow_A_tl
		\arrow{r}{\l_nicolas_tikzarrow_f_tl} \&
		\l_nicolas_tikzarrow_B_tl
	\end{tikzcd}
}
